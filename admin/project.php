...
<div class="app">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav>
            ...
            <a><i class="fas fa-pencil-alt"></i> Service</a>
            <a href="editlayanan.php" class="sub"><i class="fas fa-cogs"></i> Edit Layanan</a>
            <a href="editukuran.php" class="sub"><i class="fas fa-ruler"></i> Edit Ukuran</a>
            <a href="editjenis.php" class="sub"><i class="fas fa-palette"></i> Edit Jenis</a>
            <a href="editoutput.php" class="sub"><i class="fas fa-print"></i> Edit Output</a>
    ...
    <div class="modal-overlay-edit" id="editModalOverlay">
        <div class="edit-modal-box">
            <div class="edit-header">
                <button type="button" class="edit-back-btn" onclick="closeEditModal()"><i class="fas fa-arrow-left"></i></button>
            ...
            <form id="editForm" action="update_project.php" method="post" enctype="multipart/form-data">
                ...
                <div class="edit-body">
                    ...
                    <div class="edit-desc-area">
                        ...
                        <input type="text" name="title" id="editTitleInput" class="edit-desc-input edit-title-input" required maxlength="50">

                        <div class="edit-desc-header">
                            <span class="edit-desc-label">Deskripsi</span>
                        </div>
                        <textarea name="description" id="editDescInput" class="edit-desc-input edit-textarea-input" rows="5" required></textarea>

                        <div class="edit-desc-header" style="margin-top:14px;">
                            <span class="edit-desc-label">Ganti Gambar (opsional)</span>
                        </div>
                        <input type="file" name="image" class="edit-file-input" accept="image/jpeg,image/png,image/webp">
                    </div>
                </div>
    ...
    function openEditModal(id, title, description, image) {
        ...
        document.getElementById('editImagePreview').src = '../project_upload/' + image;
    ...
    document.querySelectorAll('.btn-edit').forEach(function (btn) {
        btn.addEventListener('click', function (e) {
            e.preventDefault();
            openEditModal(this.dataset.id, this.dataset.title, this.dataset.desc, this.dataset.image);
        });
    });
