...
// Base path untuk upload (dari folder admin ke uploads)
$uploadBase = '../uploads/';

// Ambil data order pending
$sql = "
SELECT
    ...
    s.service_name, sz.size_name, t.colour_type, outp.output_name
FROM orders o
...
$ordersPending = array_values($orderList);
?>
