        ...
        <section class="about">
            ...
            <div class="about-section">
                ...
                <div class="about-text">
                    ...
                    <p>
                        Aneka Galeri didirikan pada tahun 2018 oleh Vebrio Chang, berawal dari sebuah
                        toko kecil yang sederhana. Pada akhir Desember 2023 Aneka Galeri resmi berpindah
                        menjadi toko utama yang menghadirkan layanan lebih lengkap.
                    </p>
                    <p>
                        Seiring dengan perkembangan teknologi dan meningkatnya kebutuhan akan layanan
                        digital, Aneka Galeri bertransformasi menjadi penyedia jasa percetakan yang
                        modern dan terpercaya. Kami menyediakan berbagai layanan seperti printing,
                        pembuatan banner, desain, serta penjualan produk lainnya yang mendukung
                        kebutuhan pelanggan. Dengan komitmen pada kualitas, kemudahan, dan pelayanan
                        yang ramah, Aneka Galeri hadir sebagai mitra terpercaya untuk memenuhi berbagai
                        kebutuhan cetak dan digital Anda.
                    </p>
                </div>
                <div
                    style="width: 60%; margin: 0 auto; height: 2px; background: linear-gradient(to right, transparent, #1f8a8a, transparent);"></div>
            ...
            <div class="about-section reverse">
                ...
                <div class="about-text">
                    ...
                    <p>
                        Aneka Galeri merupakan layanan percetakan yang berkomitmen dalam memberikan
                        solusi praktis, cepat, serta berkualitas. Kami melayani berbagai macam kebutuhan
                        seperti printing, pembuatan banner, sticker, printing foto, desain grafis, dan
                        penyediaan produk pendukung lainnya.
                    </p>
                    <p>
                        Didukung dengan penggunaan peralatan yang mendukung serta mengikuti perkembangan
                        teknologi, Aneka Galeri berusaha untuk memberikan hasil yang terbaik kepada
                        setiap pelanggan. Kami juga memahami kebutuhan dari setiap kebutuhan detail dan
                        tujuan berbeda dari para pelanggan, sehingga kami siap untuk memberikan layanan
                        yang baik, fleksibel dan sesuai dengan keinginan anda. Dengan memberikan
                        pelayanan yang ramah, proses yang cepat dan mudah, serta memberikan hasil yang
                        dapat diandalkan, Aneka Galeri hadir sebagai mitra terpercaya dalam memenuhi
                        kebutuhan layanan percetakan anda
                    </p>
                </div>
            </div>
            <div
            ...
            <div class="about-cta">
                ...
                <div class="cta-inner">
                    ...
                    <p class="cta-sub">
                        Tim kami siap membantu Anda dari konsultasi desain hingga hasil cetak siap
                        pakai. Hubungi kami sekarang!
                    </p>
                    <div class="cta-buttons">
                        ...
                        <br>
                        <a href="portofolio.php" class="btn-portofolio">
                            <span class="btn-icon">📚</span>
                            Lihat Portofolio</a>
                    </div>
