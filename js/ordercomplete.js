        ...
        if (!orders || orders.length === 0) {
            listEl.innerHTML = `
                <div class="empty">
                    ...
                    <div>Belum ada order complete.</div>
                    <div style="font-size:13px;margin-top:6px;">Order yang selesai akan muncul di sini.</div>
                </div>
            `;
            return;
        }
    ...
    window.openModal = function(orderId) {
        ...
        modalBody.innerHTML = `
            ...
            <div class="info-row" style="border-bottom:none;padding-bottom:4px;margin-top:12px;">
                ...
                <span class="value" style="text-transform:capitalize;color:var(--green);">complete</span>
            </div>
            <div style="margin-top:16px;font-weight:600;font-size:14px;color:#555;">Order Status:</div>
            <div class="status-options">
                <div class="status-opt pending" data-status="pending" onclick="selectStatus('pending')">
                    <i class="fas fa-hourglass-half"></i> Pending
                </div>
                <div class="status-opt complete active" data-status="complete" onclick="selectStatus('complete')">
